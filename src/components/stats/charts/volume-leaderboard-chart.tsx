...
interface VolumeLeaderboardChartProps {}

const VolumeLeaderboardChart = ({}: VolumeLeaderboardChartProps) => {
  ...
  useEffect(() => {
    const fetchLeaderboardData = async () => {
      setLoading(true)
      try {
        const apiData = await analyticsApi.getVolumeLeaderboard(timeframe, 10)
        ...
        <BarChart data={data} layout="horizontal">
          ...
          <Tooltip 
            ...
            formatter={(value: any, name: string) => [
              name === 'volume' ? `$${(value / 1000000000).toFixed(2)}B` : value,
...
export default VolumeLeaderboardChart