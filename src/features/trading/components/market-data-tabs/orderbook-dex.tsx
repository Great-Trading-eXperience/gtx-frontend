...
const EnhancedOrderBookDex = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      const { asks: scaledAsks, bids: scaledBids }: ScaledOrderbook = scaleOrderbook(
        asks,
        bids,
        scale
      );
      ...
      const spreadPercentage =
        bestBid != 0 ? ((spreadNominal / bestBid) * 100).toFixed(3) : '0';
                ...
                <div className="flex justify-between text-gray-200">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-16 w-full">
                      <span>Spread: </span>
                      <span className="font-medium text-white">{orderBook.spread}</span>
