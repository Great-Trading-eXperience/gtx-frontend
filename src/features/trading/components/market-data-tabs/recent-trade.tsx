...
const RecentTradesComponent = ({
  ...
  const trades = calculateTotal(processTrades((tradesData as TradeItem[]) || []));
                ...
                <div key={i} className="group relative">
                  ...
                  <div className="relative grid grid-cols-3 px-4 py-1.5 text-xs">
                    <div className="flex items-center gap-1">
                      ...
                      >
                        {formatPrice(
                          formatUnits(BigInt(Math.floor(trade.price)), quoteDecimals)
                        )}
                      </span>
                    </div>
                    ...
                    <div className="text-right font-medium text-gray-200">
                      {formatPrice(formatUnits(BigInt(trade.size), baseDecimals))}
                    </div>
                  </div>
                </div>
              );
