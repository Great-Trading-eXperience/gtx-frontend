  ...
  return (
    <div className="px-6 py-12 mx-auto max-w-7xl">
      <div className="flex flex-col gap-8 relative z-10">
        ...
        {/* Market Table */}
        <div className="overflow-x-auto bg-black/60 border border-white/20 rounded-xl shadow-[0_0_25px_rgba(255,255,255,0.07)] backdrop-blur-sm max-w-7xl mx-auto w-full"></div>
      </div>
