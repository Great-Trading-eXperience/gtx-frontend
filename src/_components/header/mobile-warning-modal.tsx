            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                <p className="text-gray-300 text-sm">
                  The GTX platform is currently optimized for desktop use only. The
                  trading interface requires a larger screen for the best experience.
                </p>

                <p className="text-gray-300 text-sm">
                  Please access GTX from a desktop computer for full functionality and
