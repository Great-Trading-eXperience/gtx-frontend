...
export const OrderEncoder = {
  ...
  id: (orderData: OrderData): HexAddress => {
...
export const addressToBytes32 = (address: HexAddress): HexAddress => {
  return `0x${address.slice(2).padStart(64, '0')}` as HexAddress;
};
