import { BONK_ADDRESS, DOGE_ADDRESS, FLOKI_ADDRESS, LINK_ADDRESS, PEPE_ADDRESS, SHIBA_ADDRESS, TRUMP_ADDRESS, USDC_ADDRESS, WBTC_ADDRESS, WETH_ADDRESS } from "@/constants/contract-address";
